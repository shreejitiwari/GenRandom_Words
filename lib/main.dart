...
class MyappState extends ChangeNotifier {
  ...
  Future<void> loadFavorites() async {
    ...
    if (encodedFavorites != null) {
      favorites = encodedFavorites.map((pair) => WordPair(pair.split('_')[0], pair.split('_')[1])).toList();
    }
    notifyListeners();
  }
  ...
  Future<void> saveFavorites() async {
    final prefs = await SharedPreferences.getInstance();
    final encodedFavorites = favorites.map((pair) => pair.asPascalCase).toList();
  ...
  //@override
  void initState() {
    //super.initState(); // Call the base class (ChangeNotifier) initState
